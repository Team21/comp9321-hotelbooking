...
public class RoomTypeBean  implements Serializable {
	...
	public RoomTypeBean(int roomtypeid, int amount, int hotelid, String type,
			double price, double discountrate, Timestamp discountfrom,
			Timestamp discountto, String description) {
		super();
	...
	public String toString() {
		return "RoomTypeBean [roomtypeid=" + roomtypeid + ", amount=" + amount
				+ ", hotelid=" + hotelid + ", type=" + type + ", price="
				+ price + ", discountrate=" + discountrate + ", discountfrom="
